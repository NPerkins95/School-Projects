...
void Bank::addMoneyMarketAccount(double lowBalFee, double minBal, double interest, int accountNumber, string name) {
	MoneyMarket* acct = new MoneyMarket(lowBalFee, minBal, interest, accountNumber, name);
	accounts.push_back(acct);
}
